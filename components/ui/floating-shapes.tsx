    ...
    return (
        <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
            ...
            <motion.div
                ...
                className="absolute -bottom-[20%] -right-[10%] w-[60vw] h-[60vw] rounded-full bg-cyan-900/20 blur-[140px]"
            />
            ...
            <motion.div
                ...
                className="absolute top-[30%] left-[20%] w-[30vw] h-[30vw] rounded-full bg-fuchsia-900/10 blur-[100px]"
            />
        </div>
    );
}
